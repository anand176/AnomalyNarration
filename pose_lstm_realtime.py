...
def detect(model, lm_list):
    ...
    #     label = "NotAnomaly"
        ...
        label="NotAnomaly"
    # Uncomment and modify if you include holding and gripping datasets
